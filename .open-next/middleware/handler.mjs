...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 43: (a) => {
      (() => {
        "use strict";
        var b = { 993: (a2) => {
      ...
      "use strict";
      let d;
      c.r(b), c.d(b, { default: () => bH });
      var e, f = {};
      async function g() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(f), c.d(f, { config: () => bD, middleware: () => bC });
      let h = null;
      async function i() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let aw = process.env.NEXT_OTEL_PERFORMANCE_PREFIX, { context: ax, propagation: ay, trace: az, SpanStatusCode: aA, SpanKind: aB, ROOT_CONTEXT: aC } = d = c(683);
      ...
      async function bg(a10) {
        ...
        if (!bf && (bf = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
          let { interceptTestApis: a11, wrapRequestHandler: b3 } = c(538);
          a11(), be = b3(be);
        }
        await l();
      ...
      let bt = { current: null }, bu = "function" == typeof bh.cache ? bh.cache : (a10) => a10, bv = console.warn;
      function bw(a10) {
        return function(...b2) {
          bv(a10(...b2));
        };
      ...
      }), /* @__PURE__ */ new WeakMap(), bw(function(a10, b2) {
      ...
      async function by(a10) {
        var b2;
        let c2 = new TextEncoder(), d2 = await crypto.subtle.importKey("raw", c2.encode(process.env.SESSION_SECRET ?? process.env.AUTH_SECRET ?? process.env.NEXTAUTH_SECRET ?? "dev-session-secret-change-me"), { name: "HMAC", hash: "SHA-256" }, false, ["sign"]);
        return b2 = String.fromCharCode(...Array.from(new Uint8Array(await crypto.subtle.sign("HMAC", d2, c2.encode(a10))))), ("function" == typeof btoa ? btoa(b2) : bx.from(b2, "utf8").toString("base64")).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/g, "");
      }
      async function bz(a10) {
        let [b2, c2] = a10.split(".");
        if (!b2 || !c2 || await by(b2) !== c2) return null;
        try {
          return JSON.parse(function(a11) {
            let b3 = a11.replace(/-/g, "+").replace(/_/g, "/"), c3 = b3 + "=".repeat((4 - b3.length % 4) % 4);
            return "function" == typeof atob ? atob(c3) : bx.from(c3, "base64").toString("utf8");
          }(b2));
        } catch {
          return null;
        }
      }
      async function bA(a10) {
        if (!a10) return null;
        let b2 = await bz(a10);
        if (!b2 || "string" != typeof b2.userId) return null;
        let c2 = b2.expiresAt;
        return "number" != typeof c2 || Date.now() > c2 ? null : { userId: b2.userId };
      }
      let bB = ["/login", "/register", "/api/login", "/api/register", "/api/logout"];
      async function bC(a10) {
        let { pathname: b2 } = a10.nextUrl;
        return b2.startsWith("/_next/") || b2.startsWith("/favicon") || b2.startsWith("/logo") || bB.some((a11) => b2 === a11 || b2.startsWith(`${a11}/`)) ? S.next() : await bA(a10.cookies.get("ortho_session")?.value) ? S.next() : b2.startsWith("/api/") ? S.json({ error: "Unauthorized" }, { status: 401 }) : S.redirect(new URL("/login", a10.url));
      }
      let bD = { matcher: ["/((?!api/health).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let bE = { ...f }, bF = bE.middleware || bE.default, bG = "/middleware";
      if ("function" != typeof bF) throw Object.defineProperty(Error(`The Middleware "${bG}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false, configurable: true });
      function bH(a10) {
        return bg({ ...a10, page: bG, handler: async (...a11) => {
          try {
            return await bF(...a11);
          } catch (e2) {
...
var init_edgeFunctionHandler = __esm({
  "../../node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api\\/health).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": true }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "maximumResponseBody": 5e7, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": true }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "C:\\Users\\dell\\Desktop\\2\\ortho-reminder (3)\\ortho-reminder (3)\\ortho-reminder", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 31, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "turbopack": { "root": "C:\\Users\\dell\\Desktop\\2\\ortho-reminder (3)\\ortho-reminder (3)\\ortho-reminder" } };
var BuildId = "piVwjoXO8J8KaofRZ-URa";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/about", "regex": "^/about(?:/)?$", "routeKeys": {}, "namedRegex": "^/about(?:/)?$" }, { "page": "/add-patient", "regex": "^/add\\-patient(?:/)?$", "routeKeys": {}, "namedRegex": "^/add\\-patient(?:/)?$" }, { "page": "/archive", "regex": "^/archive(?:/)?$", "routeKeys": {}, "namedRegex": "^/archive(?:/)?$" }, { "page": "/calendar", "regex": "^/calendar(?:/)?$", "routeKeys": {}, "namedRegex": "^/calendar(?:/)?$" }, { "page": "/case-sheet", "regex": "^/case\\-sheet(?:/)?$", "routeKeys": {}, "namedRegex": "^/case\\-sheet(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/finished-cases", "regex": "^/finished\\-cases(?:/)?$", "routeKeys": {}, "namedRegex": "^/finished\\-cases(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/patients", "regex": "^/patients(?:/)?$", "routeKeys": {}, "namedRegex": "^/patients(?:/)?$" }, { "page": "/register", "regex": "^/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/register(?:/)?$" }, { "page": "/retainers", "regex": "^/retainers(?:/)?$", "routeKeys": {}, "namedRegex": "^/retainers(?:/)?$" }, { "page": "/support", "regex": "^/support(?:/)?$", "routeKeys": {}, "namedRegex": "^/support(?:/)?$" }], "dynamic": [{ "page": "/api/patients/[id]", "regex": "^/api/patients/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/patients/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/patients/[id]/appointments", "regex": "^/api/patients/([^/]+?)/appointments(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/patients/(?<nxtPid>[^/]+?)/appointments(?:/)?$" }, { "page": "/api/patients/[id]/visits", "regex": "^/api/patients/([^/]+?)/visits(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/patients/(?<nxtPid>[^/]+?)/visits(?:/)?$" }, { "page": "/api/patients/[id]/visits/[visitId]", "regex": "^/api/patients/([^/]+?)/visits/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid", "nxtPvisitId": "nxtPvisitId" }, "namedRegex": "^/api/patients/(?<nxtPid>[^/]+?)/visits/(?<nxtPvisitId>[^/]+?)(?:/)?$" }, { "page": "/api/patients/[id]/visits/[visitId]/media", "regex": "^/api/patients/([^/]+?)/visits/([^/]+?)/media(?:/)?$", "routeKeys": { "nxtPid": "nxtPid", "nxtPvisitId": "nxtPvisitId" }, "namedRegex": "^/api/patients/(?<nxtPid>[^/]+?)/visits/(?<nxtPvisitId>[^/]+?)/media(?:/)?$" }, { "page": "/api/patients/[id]/visits/[visitId]/media/[mediaId]", "regex": "^/api/patients/([^/]+?)/visits/([^/]+?)/media/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid", "nxtPvisitId": "nxtPvisitId", "nxtPmediaId": "nxtPmediaId" }, "namedRegex": "^/api/patients/(?<nxtPid>[^/]+?)/visits/(?<nxtPvisitId>[^/]+?)/media/(?<nxtPmediaId>[^/]+?)(?:/)?$" }, { "page": "/edit-patient/[id]", "regex": "^/edit\\-patient/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/edit\\-patient/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/edit-visit/[patientId]/[visitId]", "regex": "^/edit\\-visit/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPpatientId": "nxtPpatientId", "nxtPvisitId": "nxtPvisitId" }, "namedRegex": "^/edit\\-visit/(?<nxtPpatientId>[^/]+?)/(?<nxtPvisitId>[^/]+?)(?:/)?$" }, { "page": "/finish-case/[id]", "regex": "^/finish\\-case/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/finish\\-case/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/missed-appointment/[id]", "regex": "^/missed\\-appointment/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/missed\\-appointment/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/new-appointment/[id]", "regex": "^/new\\-appointment/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/new\\-appointment/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/patient/[id]", "regex": "^/patient/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/patient/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/patients/[id]", "regex": "^/patients/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/patients/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/patients/[id]/case-sheet", "regex": "^/patients/([^/]+?)/case\\-sheet(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/patients/(?<nxtPid>[^/]+?)/case\\-sheet(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/calendar": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/calendar", "dataRoute": "/calendar.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/register": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/register", "dataRoute": "/register.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/patients": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/patients", "dataRoute": "/patients.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/finished-cases": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/finished-cases", "dataRoute": "/finished-cases.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/add-patient": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/add-patient", "dataRoute": "/add-patient.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/support": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/support", "dataRoute": "/support.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/archive": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/archive", "dataRoute": "/archive.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/about": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/about", "dataRoute": "/about.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/case-sheet": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/case-sheet", "dataRoute": "/case-sheet.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/retainers": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/retainers", "dataRoute": "/retainers.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "db91c3db5ea709505aac0dbf4766a88a", "previewModeSigningKey": "c2b811f7a68576ec4675ac4a18849c95c4e178fa5c9c27bfed516c79a69309b5", "previewModeEncryptionKey": "1876d19c3cebbbf89a71d371b9a204addfc5883eeed130e53c8bdad32444ed25" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api\\/health).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!api/health).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "piVwjoXO8J8KaofRZ-URa", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "3BhjKTgb5C/yL7oACdWh2KXjbu7Kv9p5Mb3yXlwo7GU=", "__NEXT_PREVIEW_MODE_ID": "db91c3db5ea709505aac0dbf4766a88a", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "c2b811f7a68576ec4675ac4a18849c95c4e178fa5c9c27bfed516c79a69309b5", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "1876d19c3cebbbf89a71d371b9a204addfc5883eeed130e53c8bdad32444ed25" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/api/me/route": "/api/me", "/api/login/route": "/api/login", "/api/patients/[id]/appointments/route": "/api/patients/[id]/appointments", "/api/patients/[id]/visits/[visitId]/media/[mediaId]/route": "/api/patients/[id]/visits/[visitId]/media/[mediaId]", "/api/patients/[id]/route": "/api/patients/[id]", "/api/patients/[id]/visits/[visitId]/media/route": "/api/patients/[id]/visits/[visitId]/media", "/_not-found/page": "/_not-found", "/api/patients/[id]/visits/[visitId]/route": "/api/patients/[id]/visits/[visitId]", "/api/patients/[id]/visits/route": "/api/patients/[id]/visits", "/api/patients/route": "/api/patients", "/api/register/route": "/api/register", "/api/send-whatsapp/route": "/api/send-whatsapp", "/api/logout/route": "/api/logout", "/favicon.ico/route": "/favicon.ico", "/add-patient/page": "/add-patient", "/about/page": "/about", "/edit-patient/[id]/page": "/edit-patient/[id]", "/finished-cases/page": "/finished-cases", "/edit-visit/[patientId]/[visitId]/page": "/edit-visit/[patientId]/[visitId]", "/calendar/page": "/calendar", "/archive/page": "/archive", "/case-sheet/page": "/case-sheet", "/finish-case/[id]/page": "/finish-case/[id]", "/missed-appointment/[id]/page": "/missed-appointment/[id]", "/new-appointment/[id]/page": "/new-appointment/[id]", "/page": "/", "/patients/[id]/case-sheet/page": "/patients/[id]/case-sheet", "/patient/[id]/page": "/patient/[id]", "/patients/page": "/patients", "/support/page": "/support", "/retainers/page": "/retainers", "/patients/[id]/page": "/patients/[id]", "/login/page": "/login", "/register/page": "/register" };
